[//]: # (This file was generated from: doc/template/README.mdt using the documentation_builder package on: 2022-06-20 20:38:56.036332.)
...
that determines the position of the cells. All these can be set in
the [ResponsiveLayoutGrid](https://github.com/domain-centric/responsive_layout_grid/wiki/01-ResponsiveLayoutGrid#responsivelayoutgrid)
constructor.
...
* [SingleChildScrollView] if the cells do not fit and you need vertical scrolling

<a id='responsivelayoutcell'></a>

# ResponsiveLayoutCell

You can wrap your cell [Widget]s with
...
[CellAlignment](https://github.com/domain-centric/responsive_layout_grid/wiki/01-ResponsiveLayoutGrid#cellalignment)
defines
how [ResponsiveLayoutCell](https://github.com/domain-centric/responsive_layout_grid/wiki/01-ResponsiveLayoutGrid#responsivelayoutcell)
in a row are positioned:
...
is responsible for creating a [Layout]
It orders the [children](https://pub.dev/packages/children) into a Layout with a given number of
columns
